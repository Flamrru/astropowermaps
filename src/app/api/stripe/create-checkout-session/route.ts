...
export async function POST(request: NextRequest) {
  try {
    ...
    // "one_time" ($19.99), "one_time_14" ($14.99), "one_time_19" ($19.99 for new ads), "one_time_24" ($24.99), "one_time_29" ($29.99), and "winback" ($9.99) are one-time payments
    const isOneTimePayment = ["one_time", "one_time_14", "one_time_19", "one_time_24", "one_time_29", "winback"].includes(planId);
    ...
    if (isOneTimePayment) {
      ...
      const priceIdMap: Record<string, string> = {
        ...
        one_time_19: prices.ONE_TIME_19,
        ...
        line_items: [
          {
            price: planId === "winback" ? prices.WINBACK
              ...
              : planId === "one_time_19" ? prices.ONE_TIME_19
