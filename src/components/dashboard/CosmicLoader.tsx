...
// Rotating zodiac ring - positioned around the orb only, not extending to text
function ZodiacRing() {
  const zodiacSymbols = ["♈", "♉", "♊", "♋", "♌", "♍", "♎", "♏", "♐", "♑", "♒", "♓"];
    ...
    >
      <div className="relative w-48 h-48">
        {zodiacSymbols.map((symbol, i) => {
          ...
          const radius = 85; // Smaller radius to keep symbols around the orb
...
export default function CosmicLoader() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Constellation drawing area with zodiac ring contained inside */}
        <div className="relative w-48 h-48 mb-10">
          {/* Zodiac ring - contained within the orb area */}
