...
export default function StripeCheckout({ onComplete }: StripeCheckoutProps) {
  ...
  return (
    <div
      className="stripe-checkout-wrapper rounded-2xl overflow-hidden"
      style={{
